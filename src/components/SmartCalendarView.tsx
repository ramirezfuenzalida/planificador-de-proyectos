        ...
        courses.forEach(course => {
          ...
          academicEvents.push({
            ...
            title: isMuestra 
              ...
              : `Clase ${clase.clase} (${courseTag}): ${clase.objetivo || 'Proyecto'}`,
                ...
                >
                  ...
                  <div className="sc-event-details">
                    ...
                    <div className="sc-event-meta-tags">
                      {/* Category Badge - Highlighted ONLY if Muestra Pública */}
                      ...
                      {/* Custom User Event Indicator Badge */}
                      {!event.isAcademic && (
                        <span className="sc-meta-tag responsible-badge">
                          <Bookmark size={10} /> Agendado
                        </span>
                      )}
